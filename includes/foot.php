    ...
    <script src="assets/javascripts/cube.js" type="text/javascript"></script>
    <script src="assets/javascripts/underscore.min.js" type="text/javascript"></script>
    <script src="assets/javascripts/tokeninput/jquery.tokeninput.js"></script>
    ...
    <script src="app/controllers/slotsCtrl.js" type="text/javascript"></script>
    <script src="app/controllers/appointmentsCtrl.js" type="text/javascript"></script>
    <script src="app/controllers/expenseCtrl.js" type="text/javascript"></script>
    <script src="app/controllers/manageCtrl.js" type="text/javascript"></script>
